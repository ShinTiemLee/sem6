...
int main(void){
	...
	cl_mem s_mem_obj=clCreateBuffer(context,CL_MEM_WRITE_ONLY,len*sizeof(char),NULL,&ret);
	...
	printf("\n\nTime taken to execute kernel in milliseconds=%0.3f msec \n\n", total_time/1000000);
	printf("\nTime taken to execute the whole program in seconds: %0.3f secs\n",(end-start)/(double)CLOCKS_PER_SEC);
